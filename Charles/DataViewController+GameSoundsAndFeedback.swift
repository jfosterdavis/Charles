...
//            audioFilePath = nil
    ...
    func setBackground(from level:Level, animate: Bool = true) {
        ...
        let newTopBackgroundAlpha = 1 - (0.15 * newAlpha + 0.85) //y=mx+b  top half will only ever be half as dark as the other part
