...
struct Levels {
    ...
    75 : Level(level: 75, levelDescription: "perception",               xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil), //synesthesia3
