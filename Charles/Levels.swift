...
struct Levels {
    ...
    46 : Level(level: 46, name: "system",                   xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.48, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental, ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    47 : Level(level: 47, name: "ends",                     xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.45, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental, ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    48 : Level(level: 48, name: "force",                    xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.46, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental, ColorLibrary.Medium], eligibleRandomColorPrecision: 2), //stacks3
    49 : Level(level: 49, name: "attraction",               xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.47, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental, ColorLibrary.Medium], eligibleRandomColorPrecision: 3),
    50 : Level(level: 50, name: "repulsion",                xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.48, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental, ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    51 : Level(level: 51, name: "process",                  xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.49, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    52 : Level(level: 52, name: "means",                    xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.50, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    53 : Level(level: 53, name: "creation",                 xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.51, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    54 : Level(level: 54, name: "destruction",              xPRequired: 11, successThreshold: 0.77, punishThreshold: 0.52, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    55 : Level(level: 55, name: "particle",                 xPRequired: 11, successThreshold: 0.77, punishThreshold: 0.49, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    56 : Level(level: 56, name: "property",                 xPRequired: 11, successThreshold: 0.77, punishThreshold: 0.50, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2), //Adaptation 3
    57 : Level(level: 57, name: "state",                    xPRequired: 11, successThreshold: 0.77, punishThreshold: 0.51, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    58 : Level(level: 58, name: "atom",                     xPRequired: 11, successThreshold: 0.78, punishThreshold: 0.52, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    59 : Level(level: 59, name: "chemical",                 xPRequired: 11, successThreshold: 0.78, punishThreshold: 0.53, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    60 : Level(level: 60, name: "phase",                    xPRequired: 11, successThreshold: 0.78, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    61 : Level(level: 61, name: "material",                 xPRequired: 11, successThreshold: 0.78, punishThreshold: 0.57, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2), //stacks4
    62 : Level(level: 62, name: "emergence",                xPRequired: 20, successThreshold: 0.79, punishThreshold: 0.53, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    63 : Level(level: 63, name: "complex system",           xPRequired: 20, successThreshold: 0.79, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2), //insight 3
    64 : Level(level: 64, name: "replication",              xPRequired: 11, successThreshold: 0.79, punishThreshold: 0.57, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),  //Matthew Enters  //Closeenough3
    65 : Level(level: 65, name: "life",                     xPRequired: 11, successThreshold: 0.84, punishThreshold: 0.59, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    66 : Level(level: 66, name: "death",                    xPRequired: 11, successThreshold: 0.84, punishThreshold: 0.59, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    67 : Level(level: 67, name: "survival",                 xPRequired: 11, successThreshold: 0.84, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    68 : Level(level: 68, name: "need",           xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    69 : Level(level: 69, name: "organism",          xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    70 : Level(level: 70, name: "brain",                 xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    71 : Level(level: 71, name: "reality",                    xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    72 : Level(level: 72, name: "sensation",                  xPRequired: 11, successThreshold: 0.84, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    73 : Level(level: 73, name: "memory",                xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    74 : Level(level: 74, name: "perception",                   xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    75 : Level(level: 75, name: "cognition",               xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil), //synesthesia3
    76 : Level(level: 76, name: "consciousness",                xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    77 : Level(level: 77, name: "value",            xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    78 : Level(level: 78, name: "judgement",                xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    79 : Level(level: 79, name: "reason",                   xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.62, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    80 : Level(level: 80, name: "identity",                 xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.62, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    81 : Level(level: 81, name: "delusion",                 xPRequired: 11, successThreshold: 0.87, punishThreshold: 0.70, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    82 : Level(level: 82, name: "the mind",                 xPRequired: 11, successThreshold: 0.87, punishThreshold: 0.65, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2), //Adaptation 4
    83 : Level(level: 83, name: "control",                  xPRequired: 11, successThreshold: 0.87, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    84 : Level(level: 84, name: "skill",                    xPRequired: 11, successThreshold: 0.87, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    85 : Level(level: 85, name: "Ego",                      xPRequired: 11, successThreshold: 0.87, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    86 : Level(level: 86, name: "forethought",              xPRequired: 11, successThreshold: 0.87, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    87 : Level(level: 87, name: "free will",                xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    88 : Level(level: 88, name: "thinking",                 xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),  //John enters,  closeenough4
    89 : Level(level: 89, name: "intent",                   xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    90 : Level(level: 90, name: "planning",                 xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),  //last 10 levels exception to the pattern
    91 : Level(level: 91, name: "self-interest",            xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    92 : Level(level: 92, name: "philosophy",               xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    93 : Level(level: 93, name: "society",                  xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    94 : Level(level: 94, name: "persuade",                 xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.67, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    95 : Level(level: 95, name: "delegate",                 xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.66, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    96 : Level(level: 96, name: "compel",                   xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.65, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    97 : Level(level: 97, name: "good",                     xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2), //study 4 (John + 5)
    98 : Level(level: 98, name: "evil",                     xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    99 : Level(level: 99, name: "ethics",                   xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.62, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
   100 : Level(level:100, name: "values",                   xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
   101 : Level(level: 101, name: "morality",                xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
   102 : Level(level: 102, name: "respect",                 xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.57, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
   103 : Level(level: 103, name: "production",              xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
   104 : Level(level: 104, name: "wealth",                  xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
   105 : Level(level: 105, name: "thrive",                  xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2), //R0berte enters, study3
   106 : Level(level: 106, name: "flourish",                xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
   ...
   117 : Level(level: 117, name: "criminal",                xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.66, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 3),
   118 : Level(level: 118, name: "unearned greatness",      xPRequired: 50, successThreshold: 0.30, punishThreshold: 0.00, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy, ColorLibrary.Medium], eligibleRandomColorPrecision: nil),
   119 : Level(level: 119, name: "self-deception",          xPRequired: 30, successThreshold: 0.40, punishThreshold: 0.00, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 3),
   120 : Level(level: 120, name: "prestige",                xPRequired: 11, successThreshold: 0.90, punishThreshold: 0.70, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 3),
   121 : Level(level: 121, name: "power-lust",              xPRequired: 11, successThreshold: 0.91, punishThreshold: 0.73, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 3),
   122 : Level(level: 122, name: "\"the public good\"",     xPRequired: 11, successThreshold: 0.92, punishThreshold: 0.75, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 3),
   123 : Level(level: 123,name: "\"the public, c’est moi\"",xPRequired: 11, successThreshold: 0.93, punishThreshold: 0.76, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   124 : Level(level: 124, name: "abetment",                xPRequired: 5, successThreshold: 0.94, punishThreshold: 0.78, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   125 : Level(level: 125, name: "collectivism",            xPRequired: 11, successThreshold: 0.95, punishThreshold: 0.81, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   126 : Level(level: 126, name: "totalitarianism",         xPRequired: 11, successThreshold: 0.95, punishThreshold: 0.82, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   ...
   127 : Level(level: 127, name: "awakening",               xPRequired: 70, successThreshold: 0.60, punishThreshold: 0.50, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy, ColorLibrary.Medium], eligibleRandomColorPrecision: nil),
   128 : Level(level: 128, name: "love",                    xPRequired: 11, successThreshold: 0.80, punishThreshold: 0.79, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   129 : Level(level: 129, name: "love of self",            xPRequired: 11, successThreshold: 0.80, punishThreshold: 0.78, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   130 : Level(level: 130, name: "love of life",            xPRequired: 11, successThreshold: 0.78, punishThreshold: 0.77, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   131 : Level(level: 131, name: "egoism",                  xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.75, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   132 : Level(level: 132, name: "withdrawal of consent",   xPRequired: 11, successThreshold: 0.82, punishThreshold: 0.73, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   133 : Level(level: 133, name: "withdrawal of support",   xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.71, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   134 : Level(level: 134, name: "reciprocity",             xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.65, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   135 : Level(level: 135, name: "self-defense",            xPRequired: 25, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
