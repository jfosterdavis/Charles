...
struct Levels {
    ...
    51 : Level(level: 51, name: "process",                  xPRequired: 11, successThreshold: 0.74, punishThreshold: 0.49, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    52 : Level(level: 52, name: "means",                    xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.50, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    53 : Level(level: 53, name: "creation",                 xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.51, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    54 : Level(level: 54, name: "destruction",              xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.52, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    55 : Level(level: 55, name: "particle",                 xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.49, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    56 : Level(level: 56, name: "property",                 xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.50, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2), //Adaptation 3
    57 : Level(level: 57, name: "state",                    xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.51, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    58 : Level(level: 58, name: "atom",                     xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.52, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    59 : Level(level: 59, name: "chemical",                 xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.53, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    60 : Level(level: 60, name: "phase",                    xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    61 : Level(level: 61, name: "material",                 xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.57, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2), //stacks4
    ...
    65 : Level(level: 65, name: "life",                     xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.59, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    66 : Level(level: 66, name: "death",                    xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.59, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    ...
    74 : Level(level: 74, name: "perception",               xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    75 : Level(level: 75, name: "cognition",                xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil), //synesthesia3
    76 : Level(level: 76, name: "consciousness",            xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    77 : Level(level: 77, name: "value",                    xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    ...
    81 : Level(level: 81, name: "delusion",                 xPRequired: 11, successThreshold: 0.77, punishThreshold: 0.65, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    ...
    83 : Level(level: 83, name: "control",                  xPRequired: 11, successThreshold: 0.77, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    ...
    85 : Level(level: 85, name: "Ego",                      xPRequired: 11, successThreshold: 0.77, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    ...
    87 : Level(level: 87, name: "free will",                xPRequired: 11, successThreshold: 0.78, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    ...
    89 : Level(level: 89, name: "intent",                   xPRequired: 11, successThreshold: 0.78, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    ...
    91 : Level(level: 91, name: "self-interest",            xPRequired: 11, successThreshold: 0.79, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    ...
    93 : Level(level: 93, name: "society",                  xPRequired: 11, successThreshold: 0.79, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    ...
    95 : Level(level: 95, name: "delegate",                 xPRequired: 11, successThreshold: 0.80, punishThreshold: 0.66, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    ...
    97 : Level(level: 97, name: "good",                     xPRequired: 11, successThreshold: 0.80, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2), //study 4 (John + 5)
    98 : Level(level: 98, name: "evil",                     xPRequired: 11, successThreshold: 0.80, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    99 : Level(level: 99, name: "ethics",                   xPRequired: 11, successThreshold: 0.81, punishThreshold: 0.62, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
   100 : Level(level:100, name: "values",                   xPRequired: 11, successThreshold: 0.81, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
   101 : Level(level: 101, name: "morality",                xPRequired: 11, successThreshold: 0.81, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
   102 : Level(level: 102, name: "respect",                 xPRequired: 11, successThreshold: 0.81, punishThreshold: 0.57, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
   ...
   105 : Level(level: 105, name: "thrive",                  xPRequired: 11, successThreshold: 0.83, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2), //, study3
   106 : Level(level: 106, name: "flourish",                xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
   ...
   113 : Level(level: 113, name: "unearned material",       xPRequired: 35, successThreshold: 0.10, punishThreshold: 0.0 , canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy, ColorLibrary.Medium], eligibleRandomColorPrecision: nil),
   ...
   138 : Level(level: 138, name: "clear the way",           xPRequired: 11, successThreshold: 0.90, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   ...
   142 : Level(level: 142, name: "thrive",                  xPRequired: 15, successThreshold: 0.82, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   143 : Level(level: 143, name: "flourish",                xPRequired: 15, successThreshold: 0.83, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3),
   144 : Level(level: 144, name: "forget?",                 xPRequired: 15, successThreshold: 0.85, punishThreshold: 0.55, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 3)
    ]
