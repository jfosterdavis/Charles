...
struct Levels {
    ...
    5 :  Level(level: 5,  levelDescription: "n00binator",               xPRequired: 8,  successThreshold: 0.51, punishThreshold: 0.32, canBeLost: false, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    6 :  Level(level: 6,  levelDescription: "nubian",                   xPRequired: 8,  successThreshold: 0.52, punishThreshold: 0.32, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    7 :  Level(level: 7,  levelDescription: "knower of n00bs",          xPRequired: 9,  successThreshold: 0.52, punishThreshold: 0.32, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil),
    8 :  Level(level: 8,  levelDescription: "teacher of n00bs",         xPRequired: 9,  successThreshold: 0.53, punishThreshold: 0.32, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil),
    9 :  Level(level: 9,  levelDescription: "leader of n00bs",          xPRequired: 10, successThreshold: 0.54, punishThreshold: 0.32, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil),
    10 : Level(level: 10, levelDescription: "nubal academy graduate",   xPRequired: 10, successThreshold: 0.55, punishThreshold: 0.32, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil), //first 10 for training
    ...
    11 : Level(level: 11, levelDescription: "nothing",                  xPRequired: 11, successThreshold: 0.57, punishThreshold: 0.33, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil),
    ...
    30 : Level(level: 30, levelDescription: "energy",                   xPRequired: 11, successThreshold: 0.68, punishThreshold: 0.38, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 1),
    ...
    33 : Level(level: 33, levelDescription: "entity",                   xPRequired: 11, successThreshold: 0.69, punishThreshold: 0.39, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 1),
    34 : Level(level: 34, levelDescription: "class",                    xPRequired: 11, successThreshold: 0.70, punishThreshold: 0.39, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 1),
    ...
    48 : Level(level: 48, levelDescription: "force",                    xPRequired: 11, successThreshold: 0.75, punishThreshold: 0.46, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental, ColorLibrary.Medium], eligibleRandomColorPrecision: 2),
    ...
    52 : Level(level: 52, levelDescription: "means",                    xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.50, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    ...
    56 : Level(level: 56, levelDescription: "property",                 xPRequired: 11, successThreshold: 0.77, punishThreshold: 0.50, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2),
    ...
    68 : Level(level: 68, levelDescription: "objective need",           xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    69 : Level(level: 69, levelDescription: "objective value",          xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    70 : Level(level: 70, levelDescription: "organism",                 xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    71 : Level(level: 71, levelDescription: "brain",                    xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    72 : Level(level: 72, levelDescription: "reality",                  xPRequired: 11, successThreshold: 0.84, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    73 : Level(level: 73, levelDescription: "sensation",                xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.60, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
    74 : Level(level: 74, levelDescription: "memory",                   xPRequired: 11, successThreshold: 0.85, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    75 : Level(level: 75, levelDescription: "perception",               xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    76 : Level(level: 76, levelDescription: "cognition",                xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    77 : Level(level: 77, levelDescription: "consciousness",            xPRequired: 11, successThreshold: 0.86, punishThreshold: 0.61, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    ...
    82 : Level(level: 82, levelDescription: "the mind",                 xPRequired: 11, successThreshold: 0.87, punishThreshold: 0.65, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),
