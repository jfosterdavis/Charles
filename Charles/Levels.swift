...
struct Levels {
    ...
    52 : Level(level: 52, name: "means",                    xPRequired: 11, successThreshold: 0.76, punishThreshold: 0.50, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: 2), //Closeenough3
    ...
    64 : Level(level: 64, name: "replication",              xPRequired: 11, successThreshold: 0.79, punishThreshold: 0.57, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),  //Matthew Enters
