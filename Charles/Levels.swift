...
struct Levels {
    ...
    6 :  Level(level: 6,  levelDescription: "nubian",                   xPRequired: 8,  successThreshold: 0.52, punishThreshold: 0.33, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil), // stacks1
