...
struct Levels {
    ...
    4 :  Level(level: 4,  levelDescription: "n00b",                     xPRequired: 7,  successThreshold: 0.50, punishThreshold: 0.32, canBeLost: false, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil),
    5 :  Level(level: 5,  levelDescription: "n00binator",               xPRequired: 8,  successThreshold: 0.51, punishThreshold: 0.32, canBeLost: false, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil), //Laura, stacks1
    6 :  Level(level: 6,  levelDescription: "nubian",                   xPRequired: 8,  successThreshold: 0.52, punishThreshold: 0.33, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Fundamental], eligibleRandomColorPrecision: nil), //  synesthesia1
    7 :  Level(level: 7,  levelDescription: "knower of n00bs",          xPRequired: 9,  successThreshold: 0.52, punishThreshold: 0.33, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil), //study1
    8 :  Level(level: 8,  levelDescription: "teacher of n00bs",         xPRequired: 9,  successThreshold: 0.53, punishThreshold: 0.33, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil), //insight
    9 :  Level(level: 9,  levelDescription: "leader of n00bs",          xPRequired: 10, successThreshold: 0.54, punishThreshold: 0.33, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil), //closeenough1
    10 : Level(level: 10, levelDescription: "nubal academy graduate",   xPRequired: 10, successThreshold: 0.55, punishThreshold: 0.33, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy], eligibleRandomColorPrecision: nil), //Adaptation1
    ...
    15 : Level(level: 15, levelDescription: "infinite",                 xPRequired: 11, successThreshold: 0.61, punishThreshold: 0.34, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy, ColorLibrary.Medium], eligibleRandomColorPrecision: nil), //Charles
    16 : Level(level: 16, levelDescription: "nothingness",              xPRequired: 11, successThreshold: 0.61, punishThreshold: 0.34, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy, ColorLibrary.Medium], eligibleRandomColorPrecision: nil), //fred
    ...
    18 : Level(level: 18, levelDescription: "direction",                xPRequired: 11, successThreshold: 0.63, punishThreshold: 0.35, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Easy, ColorLibrary.Medium], eligibleRandomColorPrecision: nil), //synesthesia2
    ...
    88 : Level(level: 88, levelDescription: "thinking",                 xPRequired: 11, successThreshold: 0.88, punishThreshold: 0.63, canBeLost: true, eligiblePredefinedObjectives: nil, eligibleRandomColorPrecision: 2),  //John enters,  closeenough4
    ...
    97 : Level(level: 97, levelDescription: "good",                     xPRequired: 11, successThreshold: 0.89, punishThreshold: 0.64, canBeLost: true, eligiblePredefinedObjectives: [ColorLibrary.Medium], eligibleRandomColorPrecision: 2), //study 4 (John + 5)
